...
namespace Dogceo_WebTest.Backend
{
    ...
    public  static class ElementMap
    {
        ...
        public  static By TableList { get { return By.CssSelector(".smart-table-header-cell:nth-child(1) > .header-content"); } }
        ...
        public  static By Name { get { return By.XPath("//input[@name='UserName']"); } }
